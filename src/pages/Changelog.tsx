...
const changelogData: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      {
        category: "added",
        description: "Crosswind Indicator highlights amber when above 11kts",
      },
      {
        category: "added",
        description: "Dynamic Wind Gradient Calculation",
      },
    ],
  },
];
...
const getCategoryColor = (
  category: ChangelogEntry["changes"][number]["category"],
